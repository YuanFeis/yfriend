		...
		<div>
			...
			<!-- <div>
				<input type="text" class="search" id="search"
					placeholder="搜索Yfriend用户" /><img src="img/select.png" class="sea" />
			</div> -->
		</div>
	</div>
	<div id="body">
		<div id="welcome">
			<span><h1>欢迎使用 Yfriend。</h1></span> <span class="link">联系你的好友和更多精彩。获取你感兴趣的实时更新。并通过每个视角观看事件实时呈现。</span>
		</div>
		...
		<div id="rigest">
			<div class="newcomer" style="font-weight: bold;color:black;">
				新来Yfriend？<span style="color: #666;font-weight: bold">注册</span>
			</div>
		...
		<ul id="lianjie">
			...
			<li><a href="">开发者</a></li>
			<li><a href="">目录</a></li>
			<li><a href="">&copy;2019Yfriend</a></li>
		</ul>
	</div>
	<script>
		$(".txt").val("");
