...
<body>
	<div id="loader">
		<div>
			<ul class="zhuye">
				<li><img src="${pageContext.request.contextPath }/img/index.ico"><a href="index.jsp"><b>主页</b></a></li>
			</ul>
		</div>
	</div>
	...
	<c:if test="${display == 'stop' }">
		<div id="tixing">
			<span class="tishiyu">该用户已冻结！如需继续使用服务，请前往发送邮件到439295706@qq.com申请解封。</span><span
				class="cha">&times;</span>
		</div>
	</c:if>
	...
	<div id="body">
		<div id="shang">
			<div id="biao">
				<div class="deng">登录 Yfriend</div>
				<form action="${pageContext.request.contextPath }/user.do?method=checklogin" method="post">
		...
		<div id="xia">
			...
			<div>
				首次使用 Yfriend?<span id="zhuce"> 现在注册 »</span>
			</div>
		</div>
	</div>
</body>
