...
<script>
	...
	function addFriends(){
		$.ajax({
			url : "/yfriend/message.do?method=addfriend",
			type : "POST",
			asyn : true,
	...
	function getMsg(uid) {
		$.ajax({
			url : "/yfriend/message.do?method=msg&uid=" + uid,
			type : "POST",
			asyn : true,
			success : function(response) {
	...
	function shuaxin(){
		var url =  "/yfriend/message.do?method=shuaxin&uid=" +$("#xiaoxione").find(".uid").val() +"&mid=" +$(".xiaoxixiaoxi:last").find(".mid").val();
		$.ajax({
			url : url ,
			type : "POST",
			success : function(response) {
	...
	function delliaotian(uid){
		var url =  "/yfriend/message.do?method=del&uid="+ uid ;
		$.ajax({
			url : url ,
			type : "POST",
			success : function(response) {
	...
	function addMessageAll(){
		var url =  "/yfriend/message.do?method=addmsg&uid=" +$("#xiaoxione").find(".uid").val() + "&mcontent=" +$("#xiaoxikuang").val() ;
		$.ajax({
			url : url,
			type : "POST",
			asyn:false,
	...
	function getFriend() {
		$.ajax({
			url : "/yfriend/message.do?method=liebiao",
			type : "POST",
			asyn : true,
			success : function(response) {
				if (message != response) {
