...
<head>
<meta charset="utf-8">
<title>用户查询&nbsp;/&nbsp;Yfriend</title>
<link rel="icon" href="${pageContext.request.contextPath }/img/index.ico" />
...
<body>
	<div id="loader">
		...
		<div>
			...
			<div id="search">
				<input type="text" class="search" placeholder="搜索Yfriend用户"
...
$("#fanwei").bind("change", function() {
		...
		if ($("#fanwei").val() == "follow") {
			search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0&fanwei=follow');
		} else if ($("#fanwei").val() == "fans") {
			search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0&fanwei=fans');
		} else if ($("#fanwei").val() == "followtwo") {
			search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0&fanwei=followtwo');
		} else if ($("#fanwei").val() == "fanstwo") {
			search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0&fanwei=fanstwo');
		} else if ($("#fanwei").val() == "all") {
			search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=0');
		} */
		location.reload();
	})
	$("#jiazaianniu").on({
		click : function() {
			if ($(this).html().trim() == "点击加载更多") {
				if ($("#fanwei").val() == "follow") {
					search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length + '&fanwei=follow');
				} else if ($("#fanwei").val() == "fans") {
					search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length + '&fanwei=fans');
				} else if ($("#fanwei").val() == "followtwo") {
					search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length + '&fanwei=followtwo');
				} else if ($("#fanwei").val() == "fanstwo") {
					search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length + '&fanwei=fanstwo');
				} else {
					search('/yfriend/user.do?method=search&word=' + $("#searchname").html().trim() + '&pagenum=' + $(".usersinfo").length);
				}
			}
		}
	});
	...
	function addSearch(result) {
		...
		for (var i = 0; i < result.length; i++) {
			...
			if (result[i].ubg == null) {
				...
				html += 'style="background-color: ' + result[i].ucolor + ';background: url(' + yfriend + '/img/' + result[i].uname + "/" + result[i].ubg + ');';
			}
			html += 'background-size: 300px 100px;"></div><div class="waiyuan">' +
				'<div class="yuantouxiang" style="background: url(' + yfriend + '/img/' + result[i].uname + "/" + result[i].ulogo + ');background-size: 70px 70px;"></div></div>'
...
function guanzhuta(button){
	...
	/* 	if(${param.word==""}){
				if(${param.fw==1}){
					window.document.title = "你关注的人 / Yfriend";
				}else if(${param.fw==2}){
					window.document.title = "关注你的人 / Yfriend";
				}else if(${param.fw==3}){
					window.document.title = "${who.urealname} 关注的人 / Yfriend";
				}else if(${param.fw==5}){
					window.document.title = "关注 ${who.urealname} 的人 / Yfriend";
				}else{
					window.document.title = "所有用户 / Yfriend";
				}
		} */
	}
